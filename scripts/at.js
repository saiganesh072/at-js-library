  ...
  (window.adobe.target = (function () {
	...
	*/ var d = Object.getOwnPropertySymbols,
          ...
          return (
            (I.matches = function (t, e) {
              ...
              var r,
                ...
                i = !o;
              return (
                i && (o = N).appendChild(t), (r = ~I.qsa(o, e).indexOf(t)), i && N.removeChild(t), r
              );
            }),
            (o = function (t) {
    ...
    function gn(t, e, n) {
      ...
      return ((i = [t, o]),
      y(i) ? cn.race(i) : hn(new TypeError("Expected an array of promises"))).then(
        (t) => (pt(r), t),
        (t) => {
          throw (pt(r), t);
        }
    ...
    function _o(t, e) {
      return (
        ...
        Ze({ request: t }),
        co(t, e, ht).then(
          (e) => (Fe("response", e), Ze({ response: e }), { request: t, response: e })
        )
      );
    }
    const Ao = (t) => (e) => e[t],
        ...
        Oo(i, o)
          ...
          .then((t) =>
            (function (t, e) {
              ...
              const r = ki(e);
              return (
                F(r) || (n.analyticsDetails = r), Fe("request succeeded", e), An(n, ji(e)), pn(e)
              );
            })(n, t)
          )
          ["catch"]((t) =>
          ...
          .then((t) =>
            (function (t) {
              const e = Vi(t),
                n = ki(t);
              return (
                F(n) || (e.analyticsDetails = n), Fe("request succeeded", t), An(e, ji(t)), pn(t)
              );
            })(t)
          )
          ["catch"]((t) =>
      ...
      return F(o)
        ...
        : i
            .then(() =>
              (function (t) {
                return ut(
                  (t, e) => t.then(() => (Fe("Script load", e), Ze({ remoteScript: e }), Vn(e))),
                  pn(),
                  t
                );
              })(o)
          ...
          case "setAttribute":
            o.push(
              (function (t) {
                const e = {};
                if (
                  ((e.selector = t.selector), (e.cssSelector = t.cssSelector), t.attribute === Ht)
                )
          ...
          case "rearrange":
            o.push(
              (function (t) {
                ...
                return (
                  (n.selector = t.selector), (n.cssSelector = t.cssSelector), (n.content = e), n
                );
              })(t)
            );
            break;
    ...
    function Gs(t) {
      ...
      if (!F(i)) {
        const { url: t } = i;
        return (
          Fe("Redirect action", i), Ln({ url: t }), Ss("redirect-offer-event"), zs(Xt, t), pn()
        );
      }
      return (
        Mn({}),
    ...
    function Qs() {
      ...
      const e = t.pageLoadEnabled,
        n = t.viewsEnabled;
      if (!e && !n)
        return Fe(Ks, "Page load disabled"), void Ze({ source: Ks, error: "Page load disabled" });
      dr();
      const r = {};
      if (e) {
        const t = { pageLoad: {} };
    ...
    function au(t) {
      ...
      if (!De())
        return dt(t[$t]("warning", Ut)), Be(su, Ut), void Ze({ source: su, options: t, error: Ut });
      const r = (e) => uu(t, e),
        o = (e) =>
          (function (t, e) {
    ...
    function bu(t) {
      ...
      if (!De())
        return Be(gu, Ut), dt(r[$t]("warning", Ut)), void Ze({ source: gu, options: t, error: Ut });
      Fe(gu, r),
    ...
    function Cu(t, e) {
      ...
      const n = t.toLowerCase(),
        r = (function (t, e) {
          const n = {};
          return (
            (n.viewName = t), (n.impressionId = Rt()), (n.page = !0), F(e) || (n.page = !!e.page), n
          );
        })(n, e);
      Fe("[triggerView()]", n, r),
        Le()
